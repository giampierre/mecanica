          ...
          <div class="x_title">
            ...
            <ul class="nav navbar-right panel_toolbox">
              <li class="dropdown">
                ...
                data-toggle="modal" 
                data-target=".bs-example-modal-lg">Nuevo</button>
              </li>
            </ul>
...
<div class="item form-group">
  <label class="col-form-label col-md-3 col-sm-3 label-align" for="name">Articulo<span class="required">*</span>
  </label>
  <div class="col-md-6 col-sm-6">
  <input id="name" 
    class="form-control" 
    data-validate-length-range="6" d
...
<div class="item form-group">
  <label class="col-form-label col-md-3 col-sm-3 label-align" for="name">Precio<span class="required">*</span>
  </label>
  <div class="col-md-6 col-sm-6">
  <input id="name" 
  class="form-control" 
...
<div class="item form-group">
  <label class="col-form-label col-md-3 col-sm-3 label-align" for="name">Descripcion<span class="required">*</span>
  </label>
  <div class="col-md-6 col-sm-6">
<textarea id="textarea" required="required" v-model="nuevoArticulo.descripcion" name="textarea" class="form-control"></textarea>
</div>
</div>
...
<div class="form-group">
  <div class="col-md-6 offset-md-3">
    ...
    <button id="send"   class="btn btn-success"  data-dismiss="modal" @click="agregarArticulo()">Guardar</button>
  </div>
</div>
...
export default {
  ...
  methods : {
    agregarArticulo(){
      ...
      axios.post(url,app.nuevoArticulo)
      .then(response=>{
